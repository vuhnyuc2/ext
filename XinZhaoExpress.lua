...
--                                            511i Z :.:Z.                                                                                       
--                                           12:S 7Zv U jv.                 .i7r7i.                                                              
--                                         rM2 B.5i7s :. jgJ               jr.   .J7                                                             
--                                         igL 1Zs..r v Ysu.               i       Jr                                                            
--                                           Yv:PMir.:.v5.               .QMurY     K                                                            
--                                            sr:dIJd..P.             .ii:sIB .v    2.                                                           
--                                             v. :.7 7v             :Bj::.  U 2    7r                                                           
--                                             ud5dq5PBu             ii   XY .rv    s:                                                           
--                                             Br .:  ii             .QQMB1dQ1 v    7:                                                           
--                                               UBQr           .uBQ21DqX: rBY.:    7:                                                           
--                                               BEBQ7      vg2dQBPBBBMv  BvgsjJ:IY ::                                                           
--                                               BQQQ7g.   QB7rv:srrjUDXr :sB 7BBBB5K.                                                           
--                                                LI. :v7.YQ  ..qJiuPX:MgS1BMrZQMDB2E:                                                           
--                                                ZuZ.   :Bb v  7.2X  KSisLrB:.1 .:.B                                                            
--                                              .SP5 .J:   QU:   .D  Eb  v7 .B :rv  B                                                            
--                                             :2 J:   rq rD5:J2Sr rPq   vi  2B:2 7.B                                                            
--                                            .Y  Uv    BBQBQ:12 YUg:   v.j   SB   :Q                                                            
--                                            B2  Uv.         vJ2sr   sRIijK  :i.r   j                                                           
--                                            gB  :5          .BU.  SQiXr.ZQL.qP  i: v                                                           
--                                           :ir  Pv.         2:Ei.:Q5Y.  UBZ7SYr  :u5                                                           
--                                           5 :.75r.        .dI:Yj PUbYusUBr7 2rr2gPBJ                                                          
--                                          Q   R::7.           S vEURduI2ZPdE  BQqPiXB                                                          
--                                         K5v2 P iL.           d:.::i.    i  P SBX   P                                                          
--                                       .Ki :iir r7.          .X:r::....i7  rq  .qi  J                                                          
--                                      rd::i :B. rY.          Sisri..:K2. i: i:   bY  S                                                         
--                                     v75:JErRK  rr.          2  .:vUr  ir.i:gr.  :u: r7                                                        
--                                    i7 SXi.r:   rL           2rYrSPLi7i:5.MY 7sdrDsB. r:                                                       
--                                    S   .ir     sr.         7.:ii v 7vi L .K. :i7Pv r..g                                                       
--                                    JB :L.      7v       ..7.Lv: g  7:i :i r:q   .  RvSB.                                                      
--                                     QZi        L7.   7i:257U:..PL  Y.Y :r J qii. :QBiqQ                                                       
--                                     EP         rr    d2 .vi.ii v  i.Ku :7 S :: ..QD IB:                                                       
--                                     Xb         5U.    PBi::r   5  I R. v:   vr    L  :                                                        
--                                     u7         ZB     rL.     X   .ib  i  :u:     u.                                                          
--                                     XU         bd    .d      uq...:ir   .si    :   P                                                          
--                                     XQ         UX    ji: K      . . Y .dr      5i  v:                                                         
--                                      J         Pd   J: Y S     v j :Zr.J. iI    S:  U                                                         
--                                                qZ   K  u I   .X Y. d    K  :K.   2i S                                                         
--                                                PP   1. 2 s  rs 7: g2    j:   v7   7i.r                                                        
--                                                DQ    2  : 17. Y. jQ      P    .i:   SZ                                                        
--                                                EP    dBij.   J. LM       ivXXbIu1YrUBi                                                        
--                                                :i    5ruBQ LgIrPZ          5X   rrrIBd                                                        
--                                                77.   BqvX  iR2.K            rq117YLSrv                                                        
--                                                rY    sY::Zr 1UR              PP.ru2  u.                                                       
--                                                77.   dL. i 7iQ                bDL:  :Q                                                        
--                                                :v    L  ii  g:                 J  i7. Y                                                       
--                                               :sY7   Er.UK:v:                   K:   7S.                                                      
--                                               25vP   v  7  Z                    P::P: .Q17v                                                   
--                                               vr.7.  Pi:qir:                   .E.:B:idDSgbrr7                                                
--                                               ZsrUr g7 .. vQ:                   R:. .        g                                                
--                                               :J.7  BvrSui g                     r:r:ririrr7r.                                                
--                                                RB  .B5i.jQBb                                                                                  
--                                                vL  Ui5JYJuu                                                                                   
--                                                     ......                                                                                    
--
...
function XinZhao:LoadMenu()
	self.Menu = MenuElement({type = MENU, id = "XinZhaoExpress", name = Scriptname})
...
function XinZhao:CheckMana(spellSlot)
	return myHero:GetSpellData(spellSlot).mana < myHero.mana
end

function XinZhao:CanCast(spellSlot)
...
function XinZhao:CastSpell(spell,pos)
...
function XinZhao:Combo()
    if self:CanCast(_E) then 
		local ETarget = CurrentTarget(650)
		if self.Menu.ComboMode.UseE:Value() and ETarget and ETarget.pos:DistanceTo(myHero.pos) > 200 then
			if ValidTarget(ETarget, 650) then
...
function XinZhao:GetEnemyHeroes()
	self.EnemyHeroes = {}
...
function XinZhao:EnemyInRange(range)
	local count = 0
...
function XinZhao:Harass()
    if self:CanCast(_E) then 
		local ETarget = CurrentTarget(650)
		if self.Menu.HarassMode.UseE:Value() and ETarget and ETarget.pos:DistanceTo(myHero.pos) > 200 then
			if ValidTarget(ETarget, 650) then
				Control.CastSpell(HK_E, ETarget)
			end
		end
...
function XinZhao:Jungle()
    ...
    if minion and minion.team == 300 or minion.team ~= myHero.team then
        if self:CanCast(_E) then 
			if self.Menu.ClearMode.UseE:Value() and minion and ValidTarget(minion, 650) and minion.pos:DistanceTo(myHero.pos) > 200 then
