...
function Thresh:LoadMenu()
	Tocsin = MenuElement({type = MENU, id = "Thresh_Tocsin", name = "Thresh_Tocsin"})
	...
	Tocsin.Pred:MenuElement({id = "QChance", name = "Q Prediction Hitchance", value = 0.200, min = 0.05, max = 1, step = 0.01})
...
function Thresh:CastQ(target)
	local Qdata = {speed = 1200, delay = 0.50, range = 1075, width = 70 }
